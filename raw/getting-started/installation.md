...
> Install @retoo/borda via npm, pnpm, yarn, or connect via CDN.
...
For environments without a bundler (static HTML, WordPress, Webflow), load Borda via a `<script>` tag. See the [Formats](/distribution/formats#umd) page for full CDN setup instructions.
...
Package installed? Let's build your first onboarding flow in the **Quick Start** guide.
