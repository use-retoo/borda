...
import type { UseBordaOverridesReturns } from '../../borda-overrides';
import type { BordaResponsiveConfig, UseBordaResponsiveReturns } from '../types';
 ...
 */
export default function useBordaResponsive(
	config: UseBordaConfigReturns,
	configOverrides: UseBordaOverridesReturns
): UseBordaResponsiveReturns {
	 ...
	 */
	function update(breakpoints: number[], responsiveConfig: BordaResponsiveConfig) {
	...
	function destroy() {
		...
		/** Drop the responsive override layer so the resolved config returns to the base value. */
		configOverrides.set(OverrideLayer.RESPONSIVE, null);
	}
